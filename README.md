...
A command line node app which returns requested data, like iPhone's SIRI.
...
To retrieve the data that will power this app, you'll need to send requests to the Twitter, Spotify and OMDB APIs.
 ...
 Additionally, you will need to create a .env file, replacing the values with your API keys from Twitter & Spotify.
